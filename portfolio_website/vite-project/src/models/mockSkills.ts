    ...
    return [
      {
        ...
        refs: [
          {
            refgit: "https://github.com/shabalb/Scene2D_",
            name: "Графический конструктор картинок",
          },
          {
            refgit: "https://github.com/shabalb/PhotoCodeTest",
            name: "Оптический поток на видео",
          },
          {
            refgit: "https://github.com/shabalb/GatesTask",
            name: "Асинхронная работа",
          },
